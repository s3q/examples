                    ...
                    if (ele_slices_imgs.getAttributeNode('data-imgs').value == 'slide') {
                        ...
                        automatic_navigation.forEach(function (ele_automatic_navigation) {
                            ...
                            if (ele_automatic_navigation.getAttributeNode('data-automatic-navigation').value == 'true') {
                                ...
                                let automaticInt = setInterval(function () {
                        ...
                        function cancel_automatic_navigation() {

                            automatic_navigation.forEach(function (ele_automatic_navigation) {

                                ele_automatic_navigation.setAttribute('data-automatic-navigation', 'false');

                                setTimeout( _=> {

                                    ele_automatic_navigation.setAttribute('data-automatic-navigation', 'true');
